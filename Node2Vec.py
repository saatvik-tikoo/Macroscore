...
if __name__ == "__main__":
    ...
    input_file = ['data/references_network_2hops_mag.gpickle', 'data/references_network_2hops_wos.gpickle',
                  'data/citations_network_2hops_mag.gpickle']
    output_file = ['data/node2vec_references_network_2hops_mag.emb', 'data/node2vec_references_network_2hops_wos.emb',
